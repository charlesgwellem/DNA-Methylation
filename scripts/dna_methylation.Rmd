...
It is realisable on the graph that the loess fit which is in red, makes in in a way that the value at the point of the only differentially affected CpG is 0. So that point is not considered.
## Session info
